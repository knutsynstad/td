...
export const requestCastleCoinsDeposit = async (amount: number): Promise<CastleCoinsDepositResponse | null> => {
  try {
...
export const requestCastleCoinsWithdraw = async (amount: number): Promise<CastleCoinsWithdrawResponse | null> => {
  try {
